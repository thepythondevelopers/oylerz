            ...
            <div class="content-body">
                <div class="csm-card">
                    ...
                    <div class="csm-body">
                        ...
                        <form id="profile-update" method="POST" action="{{route('admin.blog.update',$blog->id)}}" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-lg-12">
        ...
        @endif
                            ...
                            <div class="col-lg-12">
                                ...
                                <figure class="uploaded_img"> 
                                    @if($blog->image!=null)
                                    <img src="{{$blog->image!=null ? url($blog->image) : ''}}"/></figure>
                                    @endif
                            </div>
                             <div class="col-lg-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_title" autocomplete="off" >{{$blog->meta_title}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_keywords" autocomplete="off" >{{$blog->meta_keywords}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description" autocomplete="off" >{{$blog->meta_description}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="btn-wrap">
