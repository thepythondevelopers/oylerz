...
<div class="content-wrap">
            <div class="content-head mb-4 d-f j-c-s-b a-i-c">
                ...
                <div class="btn-grp"> 
                <a href="{{route('admin.blog.add')}}"  class="main-btn primary-btn mr-3"> New Blog </a>
                            ...
                            <table class="table dash-table" id="dataTable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$b->title}}</td>
                                  <td><img src="{{$b->image!=null ? url($b->image) : ''}}"/></td>
                                  ...
                                  <td class="no-sort no-click" id="bread-actions">
                                        ...
                                        <a href="javascript:void(0)" title="Delete" class="icon-btn btn-danger delete" data-id="{{$b->id}}" id="delete-{{$b->id}}"><i class="voyager-trash"></i> <span class="hidden-xs hidden-sm"><i class='bx bxs-trash' ></i></span></a>
                                         <a href="{{route('admin.blog.edit',$b->id)}}" title="Edit" class="icon-btn view btn-primary"><i class='bx bxs-edit' ></i></a>
                                        <a href="{{route('admin.blog.view',$b->id)}}" title="View" class="icon-btn view btn-primary"><i class='bx bxs-show' ></i></a>
                                        </div>
                                    </td> 
...
@section('modal')
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <form action="{{route('admin.blog.delete','id')}}" id="delete_form" method="POST">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
        <form action="{{route('admin.blog.delete.all')}}" id="bulk_delete_form" method="POST">
 ...
 var deleteFormAction;
    ...
    $bulkDeleteBtn.click(function () {
        ...
        if (count) {
            ...
            $bulkDeleteInput.val('');
            // Deletion info
            var displayName = count > 1 ? 'Blogs' : 'Blog';
