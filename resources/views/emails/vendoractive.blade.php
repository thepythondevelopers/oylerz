...
<p style="margin:0px;">Hello, {{$name}} </p>
                        <p class="lead">Your account has been activated by the admin. You can login on your account by going to this url: <a href="{{route('login')}}" style="color: #f77908; text-decoration: underline;">{{route('login')}}</a></p>
                        <p>Thanks</p>
</span>
</td>
</tr>
