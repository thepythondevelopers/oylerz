...
<p style="margin:0px;">Hello {{$vendor->name}}, Booking has been made by {{$booking->name}} Email: {{$booking->email}} for date: {{$booking->date}} at {{$booking->time_slot}} </p>
<p>Invoice is attach to this mail. Please check for complete information.</p>
<p>Thanks</p>
</span>
</td>
</tr>
